...
function s_doPlugins(s) {
	...
	//why this poorly formatted code? shouldn't there be braces around if block?
	//i'm setting s.campaign in global omniture code block
	/*
	if(!s.campaign)
...
/*	s.events=s.apl(s.events,'event2',',',2) */
	...
	/* Set Time Parting Variables - SAMPLE PST */
